...
import ButtonSubmit from "../(client-components)/(HeroSearchForm2Mobile)/ButtonSubmit";
...
const BookingDatesRangeInput: FC<RentalCarDatesRangeInputProps> = ({
  className = "",
            ...
            >
              ...
              {hasButtonSubmit && (
                <div className="pr-2 xl:pr-4">
                  <ButtonSubmit  href="#" aria-label="search"/>
                </div>
              )}
            </div>
...
export default BookingDatesRangeInput;
