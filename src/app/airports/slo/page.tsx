    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const arrivalsResponse = await fetch(`/api/flights/slo?query=arrivals`);
                const arrivalsData = await arrivalsResponse.json();
                setArrivals(arrivalsData.data);

                const departuresResponse = await fetch(`/api/flights/slo?query=departures`);
    ...
    return (
        <>
            <head>
                ...
                <title>SLO International Airport (SBP) – Flights, Parking, Car Rentals & Travel Info</title>
                <meta name="description"
                      content="Official guide to San Luis Obispo County Regional Airport (SBP) – Find flight schedules, parking info, car rentals, airlines, and traveler tips for SLO International Airport."/>
                <meta name="keywords"
                      content="SLO International Airport, San Luis Obispo Airport, SBP, Flights to San Luis Obispo, SBP parking, SBP arrivals, SBP departures, car rentals SBP, airlines SBP, California airports"/>
                <meta name="author" content="San Luis Obispo County Regional Airport Authority"/>
                <meta name="robots" content="index, follow"/>

                 <meta property="og:title" content="SLO International Airport (SBP) – Flights, Parking & Travel Info"/>
                <meta property="og:description"
                      content="Get real-time arrivals and departures, parking info, car rentals, and all traveler essentials for San Luis Obispo's SLO International Airport (SBP)."/>
                <meta property="og:type" content="website"/>
                <meta property="og:url" content="https://www.sloairport.com/"/>
                <meta property="og:image" content="https://www.sloairport.com/images/terminal-exterior.jpg"/>
                <meta property="og:site_name" content="SLO International Airport"/>

                 <meta name="twitter:card" content="summary_large_image"/>
                <meta name="twitter:title" content="SLO International Airport (SBP) – Official Travel Guide"/>
                <meta name="twitter:description"
                      content="Everything you need to know about SLO International Airport: flights, airlines, parking, ground transportation, and local tips."/>
                <meta name="twitter:image" content="https://www.sloairport.com/images/terminal-exterior.jpg"/>
                <meta name="twitter:site" content="@slo_airport"/>
            </head>
            <main className="nc-PageHome relative overflow-hidden">
                <BgGlassmorphism/>
                <div className="container relative space-y-5 mt-8 mb-24 lg:space-y-8 lg:mb-8">
                    <h1 className="text-3xl font-bold">SLO Flights Schedule</h1>
