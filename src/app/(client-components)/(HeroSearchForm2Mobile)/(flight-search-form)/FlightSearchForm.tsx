...
const FlightSearchForm = () => {
  ...
  >("locationPickup");
  //
  const [locationInputPickUp, setLocationInputPickUp] = useState<any | null>("");
  const [locationInputDropOff, setLocationInputDropOff] = useState<any | null>("");
