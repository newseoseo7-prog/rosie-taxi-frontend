...
const AccountPage = () => {
  return (
    <div className="space-y-6 sm:space-y-8">
      ...
      <h2 className="text-3xl font-semibold dark:text-white">Account infomation</h2>
      ...
      <div className="flex flex-col md:flex-row">
        ...
        <div className="flex-grow mt-10 md:mt-0 md:pl-16 max-w-3xl space-y-6 dark:text-white">
          <div>
            <Label>Name</Label>
          ...
          <div className="pt-2">
            <ButtonPrimary aria-label="submit">Update info</ButtonPrimary>
          </div>
        </div>
      </div>
    </div>
