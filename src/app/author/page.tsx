...
const AuthorPage: FC<AuthorPageProps> = ({}) => {
  ...
  const renderSidebar = () => {
    return (
      <div className=" w-full flex flex-col items-center text-center sm:rounded-2xl sm:border border-neutral-200 dark:bg-neutral-700 dark:text-white dark:border-neutral-700 space-y-6 sm:space-y-7 px-0 sm:p-6 xl:p-8 ">
        <Avatar
          hasChecked
  ...
  const renderSection1 = () => {
    return (
      <div className="listingSection__wrap  dark:bg-neutral-700 dark:text-white dark:border-dark dark:border-solid dark:border ">
        <div>
            ...
            <Tab.Panels>
              <Tab.Panel className="">
                ...
                <div className="flex mt-11 justify-center items-center">
                  <ButtonSecondary  aria-label="submit">Show me more</ButtonSecondary>
                </div>
              </Tab.Panel>
              <Tab.Panel className="">
                <div className="mt-8 grid grid-cols-1 gap-6 md:gap-7 sm:grid-cols-2">
  ...
  const renderSection2 = () => {
    return (
      <div className="listingSection__wrap  dark:bg-neutral-700 dark:text-white">
        {/* HEADING */}
        ...
        <div className="divide-y divide-neutral-100 dark:divide-neutral-800">
          ...
          <CommentListing hasListingTitle className="py-8" />
          <div className="pt-8">
            <ButtonSecondary  aria-label="submit">View more 20 reviews</ButtonSecondary>
          </div>
        </div>
      </div>
    );
  ...
  return (
    <div className={`nc-AuthorPage  dark:bg-neutral-700 dark:text-white`}>
