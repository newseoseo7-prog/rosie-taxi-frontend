...
// Import the necessary type from react-datepicker
// This import is crucial for strict type matching
import type { ReactDatePickerCustomHeaderProps } from "react-datepicker";

// Import your custom date picker components
                        ...
                        >
                            ...
                            {hasButtonSubmit && (
                                <div className="pr-2 xl:pr-4">
                                    <ButtonSubmit href="#" aria-label="submit" />
                                </div>
                            )}
                        </div>
                            ...
                            <Popover.Panel className="absolute left-1/2 z-10 mt-3 top-full w-screen max-w-sm -translate-x-1/2 transform px-4 sm:px-0 lg:max-w-3xl">
                                <div className="overflow-hidden rounded-3xl shadow-lg ring-1 ring-black ring-opacity-5 bg-white dark:bg-neutral-800 p-8">
                                    <DatePicker
                                        ...
                                        inline
                                        // --- REVISED FIX FOR RENDER CUSTOM HEADER TYPE ERROR ---
                                        renderCustomHeader={(
                                            params: ReactDatePickerCustomHeaderProps // Accept the full params object
                                        ): ReactNode => (
                                            <DatePickerCustomHeaderTwoMonth {...params} /> // Pass the full params object
                                        )}
                                        // --- REVISED FIX FOR RENDER DAY CONTENTS TYPE ERROR ---
                                        renderDayContents={(
                                            dayOfMonth: number,
                                            date?: Date | undefined // Explicitly add '| undefined'
                                        ): ReactNode => (
                                            <DatePickerCustomDay
