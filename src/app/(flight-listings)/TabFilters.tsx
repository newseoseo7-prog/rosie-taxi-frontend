...
import { Dialog, DialogPanel, Popover, Tab, Transition } from "@headlessui/react";
            ...
            >
              <Popover.Panel className="absolute z-10 w-screen max-w-sm px-4 mt-3 left-0 sm:px-0 lg:max-w-md">
                <div className="overflow-hidden rounded-2xl shadow-xl bg-white dark:bg-neutral-900   border border-neutral-200 dark:border-neutral-700">
                  ...
                  <div className="p-5 bg-neutral-50 dark:bg-neutral-900 dark:border-t dark:border-neutral-800 flex items-center justify-between">
                    <ButtonThird   aria-label="submit" onClick={close} sizeClass="px-4 py-2 sm:px-5">
                      Clear
                    </ButtonThird>
                    <ButtonPrimary
                      onClick={close}
        ...
        <Transition appear show={isOpenMoreFilter} as={Fragment}>
          ...
          >
            <div className="min-h-screen text-center">
              ...
              >
                  <div style={{ display: 'inline-block', padding: '2rem 0.5rem', height: '100vh', width: '100%', maxWidth: '64rem' }}>
